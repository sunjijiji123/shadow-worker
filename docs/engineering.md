...
```bat
@echo off
REM 清理 MSYS2/MinGW,加载 MSVC + Qt6 + protoc
set "PATH=C:\Windows\System32;C:\Windows"
call "C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\VC\Auxiliary\Build\vcvars64.bat"
set "PATH=C:\Users\Administrator\code\1-ai\shadow-worker\tools\protoc\bin;C:\Qt\6.11.1\msvc2022_64\bin;C:\Qt\Tools\CMake_64\bin;C:\Qt\Tools\Ninja;%PATH%"
echo env ready
```
...
protoc:      tools\protoc\bin\protoc.exe (v25.1)
Go:          系统已装 1.26.1
项目根:      C:\Users\Administrator\code\1-ai\shadow-worker
```
...
```bash
# Go 桩
tools\protoc\bin\protoc.exe -I proto --go_out=backend/internal/grpcapi --go_opt=paths=source_relative --go-grpc_out=backend/internal/grpcapi --go-grpc_opt=paths=source_relative proto\*.proto
...
- `ai-voice-tool/`(隔壁项目)的 Win32 采集、provider 配置、Qt 截图窗口
